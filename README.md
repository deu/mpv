...
- `deu_build` **[merged to master]**: Added submodules for [ffmpeg-mpv](https://github.com/mpv-player/ffmpeg-mpv) (discontinued, switched to ffmpeg proper), [libass](https://github.com/libass/libass) and [fribidi](https://github.com/fribidi/fribidi); and a build.sh script.
